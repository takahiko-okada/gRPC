...
func (*Greeting) Descriptor() ([]byte, []int) {
	return fileDescriptor_greet_7af970451b5ffa33, []int{0}
}
...
func (*GreetRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_greet_7af970451b5ffa33, []int{1}
}
...
func (*GreetResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_greet_7af970451b5ffa33, []int{2}
}
...
func (*GreetManyTimesRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_greet_7af970451b5ffa33, []int{3}
}
...
func (*GreetManyTimesResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_greet_7af970451b5ffa33, []int{4}
}
...
func init() { proto.RegisterFile("greet/greetpb/greet.proto", fileDescriptor_greet_7af970451b5ffa33) }

var fileDescriptor_greet_7af970451b5ffa33 = []byte{
